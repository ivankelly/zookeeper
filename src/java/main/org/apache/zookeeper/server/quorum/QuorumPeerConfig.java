...
public class QuorumPeerConfig {
    ...
    private FailureDetector createFailureDetector(String fDName,
            Map<String, String> fDOptions, String fDPrefix) {
        if (fDName == null) {
            return new SlicedHeartbeatFailureDetector(tickTime);
        } else {
            ...
            return new FailureDetectorFactory().createFd(fDName, fdOptionsPrx);
        }
    }
