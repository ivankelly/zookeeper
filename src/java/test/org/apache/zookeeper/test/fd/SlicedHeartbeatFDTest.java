...
public class SlicedHeartbeatFDTest {
    ...
    @Before
    public void init() {
        this.fD = new SlicedHeartbeatFailureDetector(100);
    }
    ...
    public void testNoPingNoHeartbeat() {
        ...
        failedObjects = fD.getFailedObjects(220);
        Assert.assertTrue(failedObjects.contains("id"));
        
        fD.release("id");
        failedObjects = fD.getFailedObjects(250);
        objectsToPing = fD.getObjectsToPing(250);
        Assert.assertTrue(failedObjects.isEmpty());
        Assert.assertTrue(objectsToPing.isEmpty());
    }
    ...
    public void testHeartbeatReceiving() {
        ...
        failedObjects = fD.getFailedObjects(210);
